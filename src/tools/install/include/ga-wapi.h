...
extern void wnga_version(Integer *major, Integer *minor, Integer *patch);
...
extern void wnga_get_distribution_type(Integer g_a, char *type);
...
extern logical wnga_overlay(Integer g_a, Integer g_p);
...
extern Integer wnga_pgroup_duplicate(Integer grp);
extern Integer wnga_pgroup_self();
...
extern void wnga_get_array_name(Integer g_a, char *array_name);
...
extern void wnga_set_tiled_irreg_proc_grid(Integer g_a, Integer *mapc, Integer *nblocks, Integer *proc_grid);
...
extern void wnga_set_memory_dev(Integer g_a, char *device);
...
extern void wnga_matmul_patch_alt(char *transa, char *transb, void *alpha, void *beta, Integer g_a, Integer alo[], Integer ahi[], Integer g_b, Integer blo[], Integer bhi[], Integer g_c, Integer clo[], Integer chi[]);
